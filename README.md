...
#### Вывод
Если участники будут крутить примерно по 200 колёс добра, а один из участников — значительно больше, то вероятность того, что один пункт колеса выпадет хотя бы 7 участникам, близка к 100%. А в трёх случаях из четырёх таких пунктов будет 10 и более.

## Заключение
Рандом в RGG близок к настоящему, так как результаты теоретических расчётов соответствуют статистике прошлых сезонов. [прошлых](https://rgg.land/fall24/stats) [сезонов](https://rgg.land/stats). Также это можно проверить в предстоящем RGG, если предварительно подготовить случайно перемешанные списки колёс добра для каждого участника отдельно и убедиться, что по итогу сезона статистика не будет сильно отличаться от статистики прошедших сезонов.
